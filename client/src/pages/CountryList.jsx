    ...
    return (
        ...
        <div className="pt-20 container mx-auto p-2">
            ...
            <div className="flex items-center justify-center mt-[20px] flex-wrap">
                <img src={CHLogo} alt="Logo" className="w-16 h-16 sm:w-20 sm:h-20" />
                <div className="banner items-center justify-center ml-2 sm:ml-4">
                    ...
                    <h5 className="font-roboto text-[0.5rem] sm:text-[0.6rem] md:text-[0.7rem] font-bold text-center text-black tracking-[0.85em] sm:tracking-[0.75em]">LEARN ABOUT COUNTRIES</h5>
                </div>
            </div><br/>
